...
//takes in object and takes in built in Object and applies method of .keys
...
//is there a way to target the array in children and then use a regex.test on the array?
...
const hasChildrenEntries = (arr, character) => {
  let kids = false;
  Object.entries(arr).forEach(obj => {
